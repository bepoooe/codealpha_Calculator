class AdvancedCalculator {
    constructor() {
        ...
        this.updateDisplay();
        this.updateHistory();
        this.applyTheme();        this.updateAngleMode();
    }
      ...
      attachEventListeners() {
        ...
        document.querySelectorAll('.btn.operator').forEach(btn => {
          ...
          document.querySelectorAll('.btn.function').forEach(btn => {
            btn.addEventListener('click', () => this.inputFunction(btn.dataset.value));
        });
        
        // Control buttons
        if (this.clearAllBtn) this.clearAllBtn.addEventListener('click', () => this.clearAll());
        if (this.clearEntryBtn) this.clearEntryBtn.addEventListener('click', () => this.clearEntry());
        if (this.equalsBtn) this.equalsBtn.addEventListener('click', () => this.calculate());
